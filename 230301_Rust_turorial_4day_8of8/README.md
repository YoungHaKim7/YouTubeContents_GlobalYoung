...
<table border="1">
    ...
    <tr align="center">
        <td>23-3-01(wed.)</td>
        <td>
        <a href="https://youtu.be/ewEF8dAvC1Y">Day4___(8/8)__Android & Rust FFI<br>한글Rust_066⭐️Rust_Tutorial_4일만에_마스터하기8/8_android&rust ffi #rustlang #linuxos #concurrency</td>
    <tr align="center">
        <td>23-2-26(sun.)</td>
        <td>
