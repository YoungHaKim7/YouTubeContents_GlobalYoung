...
# Rust tutorial(WASM yew)

<br>

- Rust WASM(Web Assembly) & Rust FullStack

<table border="1">
    <tr>
    <td colspan="2" align="center">Rust tutorial(WASM series)</td>
    </tr>
    <tr align="center">
        <td>Date</td>
        <td>Title & Link</td>
    ...
    <tr align="center">
        <td>23-4-01(sat.)</td>
        <td><a href="https://youtu.be/zD3cUqbO0VU">한글Rust_070⭐️Rust FullStack_Web Assembly_WASM_yew_ver0.20tutorial #yew #webassembly #wasm</td>
    </tr>
    <tr align="center">
        <td>22-7-24(sun.)</td>
